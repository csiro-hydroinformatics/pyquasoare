...
#define QUASOARE_ERROR_INTEGRATE_WRONG_NU 1
#define QUASOARE_ERROR_INTEGRATE_OUT_OF_BOUNDS 2
#define QUASOARE_ERROR_INTEGRATE_NAN_COEFF 3
#define QUASOARE_ERROR_INTEGRATE_NOT_CONTINUOUS 4
#define QUASOARE_ERROR_INTEGRATE_NAN_SIM 5
#define QUASOARE_ERROR_INTEGRATE_NO_CONVERGENCE 6
#define QUASOARE_ERROR_INTEGRATE_TSTART_EQUAL_TEND 7

#define QUASOARE_ERROR_NFLUXES_TOO_LARGE 10


#define QUASOARE_QUAD_APPROX_SAMEALPHA 101
#define QUASOARE_QUAD_TIME_TOOLOW 102
#define QUASOARE_QUAD_FAILEDSUMCHECK 103
#define QUASOARE_QUAD_NFLUXES_TOO_LARGE 104
#define QUASOARE_QUAD_INTEGRATE_NAN_COEFF 105
#define QUASOARE_QUAD_NOT_CONTINUOUS 106
#define QUASOARE_QUAD_NO_CONVERGENCE 107
#define QUASOARE_QUAD_NAN_COEFF 108
