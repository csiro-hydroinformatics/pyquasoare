...
#define QUASOARE_INTEGRATE_WRONG_NU 1
#define QUASOARE_INTEGRATE_OUT_OF_BOUNDS 2
#define QUASOARE_INTEGRATE_NAN_COEFF 3
#define QUASOARE_INTEGRATE_NOT_CONTINUOUS 4
#define QUASOARE_INTEGRATE_NAN_SIM 5
#define QUASOARE_INTEGRATE_NO_CONVERGENCE 6
#define QUASOARE_INTEGRATE_TSTART_EQUAL_TEND 7
