...
To run all cases, the script needs to launched within a loop as follows
...
the script [figures\_generate\_all.py](scripts/quasoare_paper/2024/figures_generate_all.py).
